import {Grid, Paper, Select, Button, MenuItem, TextField, Container, Typography,
    InputLabel, FormControl,} from "@material-ui/core";
  import axios from "axios";
  import { useState, useEffect } from "react";
  import { makeStyles } from "@material-ui/core/styles";
  import { styles, difficulties, createMarkup } from "../QuizMakeup";
  import QuizTestAnswers from "./QuizTestAnswers";
  
  const useStyles = makeStyles((theme) => {
    return styles;
  });
  
  const QuizSubjectCategories = () => {
    ...
    const fetchQuizData = async () => {
      try {
        const url = `https://opentdb.com/api.php?amount=${quizNumber}&category=${
          category.id}&difficulty=${difficulty.name.toLowerCase()}`;
  ...
  export default QuizSubjectCategories;